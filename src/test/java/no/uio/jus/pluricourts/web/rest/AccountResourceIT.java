package no.uio.jus.pluricourts.web.rest;

import static no.uio.jus.pluricourts.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import no.uio.jus.pluricourts.JhipsterSampleApplicationApp;
import no.uio.jus.pluricourts.config.Constants;
import no.uio.jus.pluricourts.domain.User;
import no.uio.jus.pluricourts.repository.AuthorityRepository;
import no.uio.jus.pluricourts.repository.UserRepository;
import no.uio.jus.pluricourts.security.AuthoritiesConstants;
import no.uio.jus.pluricourts.service.UserService;
import no.uio.jus.pluricourts.service.dto.PasswordChangeDTO;
import no.uio.jus.pluricourts.service.dto.UserDTO;
import no.uio.jus.pluricourts.web.rest.vm.KeyAndPasswordVM;
import no.uio.jus.pluricourts.web.rest.vm.ManagedUserVM;
